export default function Tetobox24Website() {
  const boxes = [
    {
      name: 'Tetőbox M',
      size: '320L',
  ...
  const faq = [
    {
      ...
      a: 'A legtöbb tetősínnel vagy keresztrúddal rendelkező autóra felszerelhető. Foglalás előtt segítünk az ellenőrzésben.',
    },
    {
      ...
      <header className="sticky top-0 z-50 border-b bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <nav className="hidden gap-6 md:flex">
            <a href="#boxok" className="text-sm hover:text-black">
              Boxok
            </a>
            <a href="#arak" className="text-sm hover:text-black">
              Árak
            </a>
            <a href="#foglalas" className="text-sm hover:text-black">
              Foglalás
            </a>
            <a href="#kapcsolat" className="text-sm hover:text-black">
              Kapcsolat
            </a>
          </nav>
        </div>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#foglalas"
                className="rounded-2xl bg-black px-6 py-4 text-white transition hover:scale-105"
              >
                Foglalás indítása
              </a>
              ...
              <a
                ...
                className="rounded-2xl border px-6 py-4 transition hover:bg-gray-100"
              >
                Hívás most
              </a>
            </div>
          ...
          <div>
            <div className="rounded-[32px] border bg-gray-100 p-10 shadow-xl">
              <div className="aspect-video rounded-3xl bg-gradient-to-br from-gray-200 to-gray-300" />

              <div className="mt-8 grid grid-cols-3 gap-4 text-center">
                <div className="rounded-2xl bg-white p-4 shadow-sm">
                  <p className="text-3xl font-bold">24h</p>
                  <p className="mt-1 text-sm text-gray-500">Gyors foglalás</p>
                </div>

                <div className="rounded-2xl bg-white p-4 shadow-sm">
                  <p className="text-3xl font-bold">+50</p>
                  <p className="mt-1 text-sm text-gray-500">Elégedett ügyfél</p>
                </div>

                <div className="rounded-2xl bg-white p-4 shadow-sm">
                  <p className="text-3xl font-bold">4.9★</p>
                  <p className="mt-1 text-sm text-gray-500">Google értékelés</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="boxok" className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {boxes.map((box) => (
            <div
              key={box.name}
              className="rounded-[32px] border bg-white p-8 shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
            >
        ...
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
              <p className="text-lg text-gray-400">Hétvége</p>
              <p className="mt-4 text-4xl font-bold">7 990 Ft</p>
              <p className="mt-3 text-gray-400">Péntek–vasárnap</p>
            </div>

            <div className="rounded-3xl border border-white/10 bg-white/10 p-8">
              <p className="text-lg text-gray-400">1 hét</p>
              <p className="mt-4 text-4xl font-bold">19 990 Ft</p>
              <p className="mt-3 text-gray-400">Legnépszerűbb választás</p>
            </div>

            <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
              <p className="text-lg text-gray-400">2 hét</p>
              <p className="mt-4 text-4xl font-bold">34 990 Ft</p>
              <p className="mt-3 text-gray-400">Hosszabb utazásokhoz</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="foglalas" className="mx-auto max-w-5xl px-6 py-20">
        <div className="rounded-[32px] border bg-gray-50 p-10 md:p-16">
          ...
          <form className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <input
              type="text"
              placeholder="Utazás időpontja"
              className="rounded-2xl border bg-white px-5 py-4 outline-none"
            />

            <textarea
              placeholder="Megjegyzés"
              className="min-h-[140px] rounded-2xl border bg-white px-5 py-4 outline-none md:col-span-2"
            />
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 md:grid-cols-2">
          ...
          <div className="rounded-[32px] border bg-white p-10 shadow-sm">
            ...
            <div className="mt-8 space-y-6 text-gray-600">
              <div>
                <p className="font-semibold text-black">Prémium eszközök</p>
                <p className="mt-2">
                  Modern, biztonságos és rendszeresen ellenőrzött tetőboxok.
                </p>
              </div>

              <div>
                <p className="font-semibold text-black">Segítünk a választásban</p>
                <p className="mt-2">
                  Nem kell tudnod milyen box kell az autódra — segítünk.
                </p>
              </div>

              <div>
                <p className="font-semibold text-black">Gyors ügyintézés</p>
                <p className="mt-2">
                  Foglalás akár még az indulás előtti napon is.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 text-center md:flex-row md:text-left">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Tetőbox bérlés Dunaújváros és környéke
            </p>
          </div>

          <p className="text-sm text-gray-500">
            © 2026 Tetőbox24 — Minden jog fenntartva.
          </p>
        </div>
      </footer>
    </div>
